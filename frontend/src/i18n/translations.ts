...
export interface Translations {
  ...
  manageSubscription: {
    ...
    cancelScheduledChangeConfirmTitle: string;
    retryCta: string;
    accessUntil: string;
...
const translations: Record<Locale, Translations> = {
  "en-US": {
    ...
    manageSubscription: {
      ...
      cancelConfirmBody: "Stay on {plan} until {date}. After that, your account moves to Free.",
      confirmQuestion: "Would you like to continue with this change?",
      changePlanCta: "Change plan",
      changePlanConfirmTitle: "Ready to Switch Plans?",
      ...
      cancelScheduledChangeConfirmTitle: "Cancel Scheduled Change?",
  ...
  "fr-FR": {
    ...
    manageSubscription: {
      ...
      cancelConfirmBody: "Restez sur {plan} jusqu'au {date}. Ensuite, votre compte passera à l'offre Gratuite.",
      confirmQuestion: "Souhaitez-vous continuer avec ce changement ?",
      changePlanCta: "Changer de formule",
      changePlanConfirmTitle: "Prêt à changer de formule ?",
      ...
      cancelScheduledChangeConfirmTitle: "Annuler le changement prévu ?",
  ...
  "de-DE": {
    ...
    manageSubscription: {
      ...
      cancelConfirmBody: "Sie bleiben bis zum {date} bei {plan}. Danach wechselt Ihr Konto zu Kostenlos.",
      confirmQuestion: "Möchten Sie mit dieser Änderung fortfahren?",
      changePlanCta: "Plan ändern",
      changePlanConfirmTitle: "Bereit, den Plan zu wechseln?",
      ...
      cancelScheduledChangeConfirmTitle: "Geplanten Wechsel abbrechen?",
  ...
  "hi-IN": {
    ...
    manageSubscription: {
      ...
      cancelConfirmBody: "{date} तक आप {plan} पर बने रहेंगे। उसके बाद आपका खाता निःशुल्क प्लान पर चला जाएगा।",
      confirmQuestion: "क्या आप इस बदलाव के साथ आगे बढ़ना चाहेंगे?",
      changePlanCta: "प्लान बदलें",
      changePlanConfirmTitle: "प्लान बदलने के लिए तैयार हैं?",
      ...
      cancelScheduledChangeConfirmTitle: "निर्धारित बदलाव रद्द करें?",
  ...
  "id-ID": {
    ...
    manageSubscription: {
      ...
      cancelConfirmBody: "Anda akan tetap di {plan} hingga {date}. Setelah itu, akun Anda akan beralih ke Gratis.",
      confirmQuestion: "Apakah Anda ingin melanjutkan perubahan ini?",
      changePlanCta: "Ubah paket",
      changePlanConfirmTitle: "Siap Beralih Paket?",
      ...
      cancelScheduledChangeConfirmTitle: "Batalkan Perubahan Terjadwal?",
  ...
  "it-IT": {
    ...
    manageSubscription: {
      ...
      cancelConfirmTitle: "Annullare il tuo abbonamento?",
      cancelConfirmBody: "Rimarrai su {plan} fino al {date}. Successivamente, il tuo account passerà al piano Gratuito.",
      confirmQuestion: "Vuoi continuare con questa modifica?",
      changePlanCta: "Cambia piano",
      changePlanConfirmTitle: "Pronto a cambiare piano?",
      ...
      cancelScheduledChangeConfirmTitle: "Annullare la modifica programmata?",
  ...
  "ja-JP": {
    ...
    manageSubscription: {
      ...
      cancelConfirmBody: "{date}まで{plan}をご利用いただけます。それ以降、アカウントは無料プランに移行します。",
      confirmQuestion: "この変更を続けますか?",
      changePlanCta: "プランを変更",
      changePlanConfirmTitle: "プランを変更しますか?",
      ...
      cancelScheduledChangeConfirmTitle: "予定されている変更をキャンセルしますか?",
      retryCta: "支払いを再試行",
  ...
  "ko-KR": {
    ...
    manageSubscription: {
      ...
      cancelConfirmBody: "{date}까지 {plan}을(를) 유지합니다. 이후 계정은 무료 플랜으로 전환됩니다.",
      confirmQuestion: "이 변경을 계속 진행하시겠습니까?",
      changePlanCta: "요금제 변경",
      changePlanConfirmTitle: "플랜을 변경할 준비가 되셨나요?",
      ...
      cancelScheduledChangeConfirmTitle: "예정된 변경을 취소하시겠습니까?",
      retryCta: "결제 다시 시도",
  ...
  "pt-BR": {
    ...
    manageSubscription: {
      ...
      cancelConfirmBody: "Você continuará no {plan} até {date}. Depois disso, sua conta passará para o plano Gratuito.",
      confirmQuestion: "Deseja continuar com essa alteração?",
      changePlanCta: "Mudar de plano",
      changePlanConfirmTitle: "Pronto para Trocar de Plano?",
      ...
      cancelScheduledChangeConfirmTitle: "Cancelar a alteração agendada?",
  ...
  "es-419": {
    ...
    manageSubscription: {
      ...
      cancelConfirmBody: "Te quedarás con {plan} hasta el {date}. Después, tu cuenta pasará al plan Gratis.",
      confirmQuestion: "¿Deseas continuar con este cambio?",
      changePlanCta: "Cambiar de plan",
      changePlanConfirmTitle: "¿Listo para cambiar de plan?",
      ...
      cancelScheduledChangeConfirmTitle: "¿Cancelar el cambio programado?",
